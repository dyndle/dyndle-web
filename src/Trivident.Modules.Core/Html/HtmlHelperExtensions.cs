...
namespace Trivident.Modules.Core.Html
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        /// <summary>
        /// Renders the includes using the <see cref="Trivident.Modules.Core.Controllers.PageController"/>. The URL of the includes page is configured in the IncludesUrl appSetting.
        /// </summary>
        /// <param name="htmlHelper">The HTML helper.</param>
        ...
        /// <summary>
        /// Renders the includes using the <see cref="Trivident.Modules.Core.Controllers.PageController"/>.
        /// </summary>
        /// <param name="htmlHelper">The HTML helper.</param>
