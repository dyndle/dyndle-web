...
namespace Dyndle.Modules.Core.Attributes.Filter
{
    ...
    public class AbsoluteUrlFilter : MemoryStream
    {
        ...
        private readonly Regex _imgRegex;
        ...
        public AbsoluteUrlFilter(Stream stream, Uri baseUri)
        {
            ...
            _imgRegex = new Regex("<img\\s[^>]*src=(?!\"http|\"/Preview)(.*)[^>]*>", RegexOptions.Compiled);
        ...
        public override void Close()
        {
            ...
            payload = ServeAbsoluteUrls(payload, _imgRegex.Matches(payload), SrcUrlPattern);
